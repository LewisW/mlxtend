...
from mlxtend.classifier import MetaClassifier
...
def test_MetaClassifier():
    np.random.seed(123)
    meta = LogisticRegression(solver='liblinear',
                              multi_class='ovr',)
    clf1 = RandomForestClassifier(n_estimators=10)
    sclf = MetaClassifier(classifier=clf1,
...
def test_fit_base_estimators_false():
    ...
    sclf = MetaClassifier(classifier=clf1, meta_classifier=meta,
...
def test_use_clones():
    ...
    meta = LogisticRegression(solver='liblinear',
                              multi_class='ovr')
    clf1 = RandomForestClassifier(n_estimators=10)
    MetaClassifier(classifier=clf1,
                       use_clones=True,
...
def test_MetaClassifier_proba_avg_1():
...
def test_MetaClassifier_proba_concat_1():
...
def test_MetaClassifier_avg_vs_concat():
    np.random.seed(123)
    lr1 = LogisticRegression(solver='liblinear',
                             multi_class='ovr')
    sclf1 = MetaClassifier(classifier=l1r,
                               use_probas=True,
                               average_probas=True,
                               meta_classifier=lr1)
    ...
    sclf2 = MetaClassifier(classifier=l1r,
                               use_probas=True,
                               average_probas=False,
                               meta_classifier=lr1)
...
def test_MetaClassifier_drop_proba_col():
    np.random.seed(123)
    lr1 = LogisticRegression(solver='liblinear',
                             multi_class='ovr')
    sclf1 = MetaClassifier(classifier=l1r,
    ...
    sclf4 = MetaClassifier(classifier=l1r,
                               use_probas=True,
    ...
    sclf3 = MetaClassifier(classifier=l1r,
                               use_probas=True,
                               drop_proba_col='last',
                               meta_classifier=lr1)
...
def test_not_fitted():
    ...
    assert_raises(NotFittedError,
                  "This MetaClassifier instance is not fitted yet."
                  " Call 'fit' with appropriate arguments"
...
def test_classifier_gridsearch():
    ...
    assert len(grid.best_params_['classifier']) == 2
...
def test_train_meta_features_():
    ...
    lr = LogisticRegression(solver='liblinear',
                            multi_class='ovr')
    stclf = MetaClassifier(classifier=knn,
                               meta_classifier=lr,
